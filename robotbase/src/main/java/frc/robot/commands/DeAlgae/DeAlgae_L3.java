...
public class DeAlgae_L3 extends SequentialCommandGroup {
  ...
  public DeAlgae_L3() {
    super(
      ...
      new ElevatorSetDistance(ELEVATOR.SETPOINT.HIGH_ALGAE).until(
        Robot.elevator::isAtTarget
      ),
      new ParallelCommandGroup(
        new ElevatorSetDistance(ELEVATOR.SETPOINT.HIGH_ALGAE),
