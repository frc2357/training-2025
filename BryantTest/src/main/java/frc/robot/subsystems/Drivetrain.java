...
private AnalogInput m_rangerFinder = new AnalogInput(2);
private AnalogInput m_leftFollower = new AnalogInput(0);
  ...
  @Override
  public void periodic() {System.out.println(m_rangerFinder.getVoltage());
    //System.out.println(m_leftFollower.getVoltage());
